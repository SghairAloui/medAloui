...
export class SignUpFormComponent implements OnInit {
  ...
  checkFirstName() {
    if (this.firstName.length < 3) {
      ...
      if (this.re.test(this.firstName) || this.re1.test(this.firstName)) {
  ...
  checkPharmacyNameAndUserName() {
    ...
    if (this.pharmacyName.length < 3) {
      ...
      if (this.re.test(this.pharmacyName) || this.re1.test(this.pharmacyName)) {
  ...
  checkLastName() {
    if (this.lastName.length < 3) {
      ...
      if (this.re.test(this.lastName) || this.re1.test(this.lastName)) {
